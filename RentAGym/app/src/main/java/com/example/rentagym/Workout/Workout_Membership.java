...
public class Workout_Membership extends AppCompatActivity
{
    Button bRegister;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_workout_membership);

        bRegister = findViewById(R.id.bWorkRegister);
        bRegister.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
                startActivity(new Intent(Workout_Membership.this, Workout_Login.class));
            }
        });
    }
    //Menu Options
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        switch (item.getItemId())
        {
            ...
            case R.id.Item2:
                ...
                Intent intent = new Intent(Workout_Membership.this, GoogleMaps.class);
                startActivity(intent);
                return true;
            case R.id.Item3:
                Toast.makeText(this, "Help", Toast.LENGTH_SHORT).show();
                Intent helpIntent = new Intent(Workout_Membership.this, Help.class);
                startActivity(helpIntent);
                return true;
            case R.id.Item4:
                Toast.makeText(this, "Setting", Toast.LENGTH_SHORT).show();
                Intent i = new Intent(Workout_Membership.this, Setting.class);
                startActivity(i);
                return true;
            case R.id.Item5:
