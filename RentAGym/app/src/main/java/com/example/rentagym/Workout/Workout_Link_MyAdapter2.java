...
public class Workout_Link_MyAdapter2 extends RecyclerView.Adapter<Workout_Link_MyAdapter2.ViewHolder>
{
    ...
    public Workout_Link_MyAdapter2(Context ctx, ArrayList<String> titles, List<Integer> images, RVClickListener listener, String [] gymClip, String [] gymWikiHow){
        this.titles = titles;
        this.images = images;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View listView = inflater.inflate(R.layout.activity_workout_link_grid_layout, parent, false);
